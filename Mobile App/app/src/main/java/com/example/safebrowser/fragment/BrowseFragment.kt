        ...
        binding.webView.apply {
            ...
            webViewClient= object: WebViewClient(){
                ...
                override fun onPageFinished(view: WebView?, url: String?) {
                    ...
                    val commercialWebsites = listOf(
                        "Amazon", "Flipkart", "eBay", "Walmart", "Alibaba",
                        "Target", "BestBuy", "Etsy", "ASOS", "Zappos",

                    )
                    val isCommercialWebsite = commercialWebsites.any { url?.contains(it, ignoreCase = true) == true }
                    if (isCommercialWebsite) {
                        extractAndPassText()
                    } else {
                        Toast.makeText(requireContext(), "This is not a commercial website", Toast.LENGTH_LONG).show()
                    }
