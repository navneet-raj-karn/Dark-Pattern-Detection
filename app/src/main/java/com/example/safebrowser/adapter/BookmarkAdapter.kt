...
import com.example.safebrowser.databinding.BookmarkViewBinding
import com.example.safebrowser.databinding.LongBookmarkViewBinding
...
class BookmarkAdapter(private val context: Context, private val isActivity: Boolean = false): RecyclerView.Adapter<BookmarkAdapter.MyHolder>() {
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        ...
        holder.root.setOnClickListener{
            ...
            when{
                context.checkForInternet(context) -> {
                    context.changeTab(
